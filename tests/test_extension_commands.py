...
def test_call_imported_project_submanifest_commands_from_project_subdirectory(repos_tmpdir):
    ...
    # The same paths must work a project is imported and when it is initialised directly,
    ...
    add_commit(
        ...
        files={
            ...
            'mf_subdir/scripts/west-commands.yml': MF_SUB_COMMANDS_YML,
            'mf_subdir/test/west-commands/west.py': MF_SUB_WEST_PY,
        },
    )
