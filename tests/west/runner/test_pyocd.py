...
from west.runner.pyocd import PyOcdBinaryRunner
...
@patch('west.runner.pyocd.PyOcdBinaryRunner.check_call')
...
@patch('west.runner.pyocd.PyOcdBinaryRunner.run_server_and_client')
...
# mock and verify west.runner.core.BuildConfiguration usage.)
#
...
@patch('west.runner.pyocd.BuildConfiguration')
@patch('west.runner.pyocd.PyOcdBinaryRunner.check_call')
